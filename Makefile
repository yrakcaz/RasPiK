...
C_SRC := src/utils.c src/graphics.c src/klog.c src/mem.c src/driver.c src/process.c\
		 src/scheduler.c src/syscall.c src/interrupts.c src/atags.c src/vfs.c src/io.c src/main.c
