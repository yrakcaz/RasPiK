...
C_SRC := src/utils.c src/mmio.c src/mailbox.c src/graphics.c src/klog.c src/atags.c              \
		 src/mem.c src/syscall.c src/timers.c src/interrupts.c src/process.c src/elf.c           \
