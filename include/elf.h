...
// Switching to user mode (CPSR mode bits 0x10) before jumping to the ELF
// entry point is not yet implemented. Loaded programs currently run in
// the same privileged mode as the kernel.
